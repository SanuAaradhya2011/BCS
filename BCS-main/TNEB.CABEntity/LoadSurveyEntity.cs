...
{
    public class IECLoadSurveyEntity : EntityBase
    {
        ...
        public string AvgNeutralCurrent
        {
        ...
        private int isDLMS = 0;
        /// <summary>
        /// Gets or sets the isDLMS variable.
        /// isDLMS signifies whether the record is of DLMS.
        /// </summary>
        public int IsDLMS
        {
            get
