...
namespace CAB.DALC.Data
{
    ...
    { 
        ...
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(ConsumerTypeMasterDAL).ToString());
        ...
        { 
            ...
            qry[3] = "Insert Into consumertype_master(ConsumerType_Name) values('DT')";
                qry[4] = "Insert Into consumertype_master(ConsumerType_Name) values('Others')";
                qry[5] = "Insert Into consumertype_master(ConsumerType_Name) values('LT Bulk Customer')"; 
