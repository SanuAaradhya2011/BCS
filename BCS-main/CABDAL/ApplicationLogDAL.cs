...
namespace CAB.DALC.Data
{
    public class ApplicationLogDAL : DALBase
    {
        ...
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(ApplicationLogDAL).ToString());
        ...
        public bool UpdateData(long logId)
        {
            ...
            {
                logger.Log(LOGLEVELS.Error, "UpdateData(long logId)", ex);
            }
            return flag;
        }
