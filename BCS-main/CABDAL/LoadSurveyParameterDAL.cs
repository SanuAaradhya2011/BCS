...
namespace CAB.DALC.Data
{
    public class LoadSurveyParameterDAL : DALBase
    {
        ...
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(LoadSurveyParameterDAL).ToString());

        public override IEntity InsertData(IEntity entity)
        {
            LoadSurveyParameterEntity loadSurveyParameterEntity = null;
            if (entity == null)
                return loadSurveyParameterEntity;
              loadSurveyParameterEntity = entity as LoadSurveyParameterEntity;
            bool Flag = false;
            try
            {
        ...
        public  IEntity GetDetailData(long id)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                    loadSurveyParameterEntity = (LoadSurveyParameterEntity)RowToEntity(ds.Tables[0].Rows[0]);
        ...
        public DataSet GetColumnNamesForMeterID(string meterID)
        {
            ...
            try
            {
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                builder.Append("SELECT distinct parameter.ColumnsNames  FROM loadsurveyparameter parameter , meterdata mdata");
