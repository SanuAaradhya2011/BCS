...
{
    public class ReadoutPhasorForSingllePhaseIEC : ReadBase
    { 
        private bool isPhasor;
        public ReadoutPhasorForSingllePhaseIEC()
        {
            ...
            try
            {
                ...
                { 
                    ...
                    if (communications.SignOnForSPhaseIEC())
                    {
                        ...
                        communications.DelayExecution();
                        Thread.Sleep(200);
                        Application.DoEvents();// Story - 354382 - Progress bar is not moving while reading Phasor for single phase
