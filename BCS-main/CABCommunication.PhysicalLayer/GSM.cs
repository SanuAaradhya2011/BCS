...
namespace CABCommunication.PhysicalLayer
{
    ...
    /// </summary>
    public class GSM : SerialPort, IPhysicalChannel
    {
        ...
        public GSM(ChannelInformation channelInfo)
        {
        ...
        public bool OpenSession()
        {
            ...
            this.noOfRetry = channelInformation.NoOfRetries;
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (response.RecieveDataLength > 11)
                                {
                                    ...
                                    response.ErrorCode = CommunicationErrorType.SuccessForIEC;
                                    //SuccessForIECSP;
                                }
