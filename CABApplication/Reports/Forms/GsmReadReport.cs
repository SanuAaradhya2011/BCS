...
namespace CAB.UI
{
    public partial class GsmReadReport : CABForm
    {
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            if (validate() == true)
            {
                ...
                lstReportEntity = gsmConfigBLL.GetReadReportData(DateTime.Parse(dtpFrom.Value.ToShortDateString() + " 00:00:00"), DateTime.Parse(dtpTo.Value.ToShortDateString() + " 23:59:59"), lstTaskList.Text);
        ...
        private void FillGsmXSD(List<GSMConfigReportEntity> lstReportEntity)
        {
            ...
            {
                reportRow = reportXSD.Tables["GSMReadDetails"].NewRow();
                ...
                reportXSD.Tables["GSMReadDetails"].Rows.Add(reportRow);
            }
        }
        ...
        private void ShowReport()
        {
            ...
            CABApplication.Reports.DLMS_Detailed_Reports.GSMReadReport gsmrReadReport = new GSMReadReport();

            // Apply modern blue theme and custom logo before rendering
            ReportThemeHelper.Apply(gsmrReadReport);

            //assinging data source to GSMSuccessReport
            gsmrReadReport.SetDataSource(reportXSD);

            //assinging data source to ReportForm
            objReportForm.rptViewer.ReportSource = gsmrReadReport;
        ...
        private void btnTaskID_Click(object sender, EventArgs e)
        {
           ...
           Tds = gsmConfigBLL.ReadTaskID(dtpFrom.Value, dtpTo.Value);
