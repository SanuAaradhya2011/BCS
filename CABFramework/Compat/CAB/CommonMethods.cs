  ...
  public static  class CommonMethods
    {
      ...
      public static string GetConfigSettingValue(string Key)
        ...
        public static int GetDisplayProgrammingVariantFromSignature(string signatureData)
        {
            ...
            if (signatureData.Trim().Length < startIDX + EndIDX) return (int)LNG.Framework.DisplayProgrammingTypes.OneByte;
            else
            {
                int.TryParse(signatureData.Substring(startIDX, EndIDX), out int dispVariant);
                if (dispVariant == (int)LNG.Framework.DisplayProgrammingTypes.TwoByte)
                {
                    LNG.Framework.Utility.ConfigInfo.DisplayProgrammingVariant = LNG.Framework.DisplayProgrammingTypes.TwoByte;
                }
                else
                {
                    LNG.Framework.Utility.ConfigInfo.DisplayProgrammingVariant = LNG.Framework.DisplayProgrammingTypes.OneByte;
                }
                return dispVariant ;
            }
        }
