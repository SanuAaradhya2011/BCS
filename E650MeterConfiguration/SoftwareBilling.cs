...
{
    /// <summary>
    /// Software billing Writing support
    /// </summary>
    public class SoftwareBilling : BaseConfig
    {
        ...
        #region Constructor
        public SoftwareBilling(bool isLittleEndian)
            : base(isLittleEndian)
        { }
        #endregion
        ...
        private List<MeterDataPacket> GetMeterDataPackets(DLMSCOMMAND dlmsCommand, ExtendedBinaryReader reader)
        {
            ...
            try
            {
                // VisibleString stringType = new VisibleString();
                // stringType.LengthInBytes = 4;
