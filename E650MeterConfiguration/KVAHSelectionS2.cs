...
{
    /// <summary>
    /// Programming support for KVAH Slection changed
    /// </summary>
    public class KVAHSelectionS2:BaseConfig
    {
        #region Nested Types
        #endregion
        ...
        #region Constructor
        public KVAHSelectionS2(bool isLittleEndian)
            : base(isLittleEndian)
        { }
        #endregion
        ...
        private List<MeterDataPacket> GetMeterDataPackets(DLMSCOMMAND dlmsCommand, ExtendedBinaryReader reader)
        {
            ...
            try
            {
                ...
                string actulData = binaryData[18].ToString();
