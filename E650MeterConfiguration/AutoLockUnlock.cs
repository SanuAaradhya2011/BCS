...
namespace CAB.E650MeterConfiguration
{
    ...
    /// </summary>
    public class AutoLockUnlock : BaseConfig
    {
        #region Nested Types
        #endregion

        #region Constants and Variables
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(AutoLockUnlock).ToString());
        #endregion
        ...
        #region Constructor
        public AutoLockUnlock(bool isLittleEndian)
            : base(isLittleEndian)
        { }
        #endregion
