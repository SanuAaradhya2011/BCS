...
namespace CAB.E650MeterConfiguration
{
    ...
    /// </summary>
    /// [BillingType_Month]
    public class BillingMonthType : BaseConfig
    {
        #region Nested Types
        #endregion

        #region Constants and Variables
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(BillingMonthType).ToString());
        #endregion
        ...
        #region Constructor
        public BillingMonthType(bool isLittleEndian)
            : base(isLittleEndian)
        { }
        #endregion
        ...
        public override ProfileData ParseData(byte[] bytes, DLMSCOMMAND command)
        {
            ...
            // 20190206 A.S. added to prevent error decoding 2ng file converted by analogics from raw
            try
            {
