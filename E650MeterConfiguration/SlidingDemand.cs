...
namespace CAB.E650MeterConfiguration
{
    ...
    /// </summary>
    public class SlidingDemand : BaseConfig
    {
        #region Nested Types
        #endregion
        ...
        #region Constructor
        public SlidingDemand(bool isLittleEndian)
            : base(isLittleEndian)
        { }
        #endregion
        ...
        /// <summary>
        /// Used to get byte list from input CTRatio value
        /// </summary>
        /// <returns></returns>
        ...
        public override ProfileData ParseData(byte[] bytes, DLMSCOMMAND command)
        {
            ...
            //{
                ...
                //List<byte> meterDataPackets = new List<byte>();
              //  ExtendedBinaryReader reader = GetReader(bytes);
        ...
        {
            Long type = new Long();
            meterDataPacket.ListDataElementValue.Add(GetDataElement(dlmsCommand, type.GetValue(reader, new DataElementConfiguration()), string.Empty));
            meterDataPackets.Add(meterDataPacket);
