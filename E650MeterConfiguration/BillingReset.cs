...
namespace CAB.E650MeterConfiguration
{
    ...
    /// </summary>
    public class BillingReset : BaseConfig
    {
        #region Nested Types
        #endregion

        #region Constants and Variables
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(BillingReset).ToString());
        #endregion
        ...
        #region Constructor
        public BillingReset(bool isLittleEndian)
            : base(isLittleEndian)
        { }
        #endregion
