    ...
    public class GSMScheduleDAL : DALBase 
    {
        ...
        public override IEntity InsertData(IEntity entity)
        {
            ...
            try
            {
                ...
                builder.Append("Insert Into gsmSchedule(Schedule_Name,Schedule_Period,Period_DayName,Period_DayNumber,CreationDate,CreationTime,Schedule_Parameter,Status) values(");
                ...
                builder.Append(string.Concat(ParameterName(CreationTime), ","));
                ...
                request.AddParamter(ParameterName(CreationDate), gsmScheduleEntity.CreationDate, DbType.Int64);
                request.AddParamter(ParameterName(CreationTime), gsmScheduleEntity.CreationTime, DbType.String, 10);
        ...
        { 
            ...
            { 
                ...
                builder.Append(string.Concat(CreationTime, "=", ParameterName(CreationTime), ","));
        ...
        public override IEntity GetDetailData(int id)
        {
            ...
            try
            {
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                builder.Append("Select gsmSchedule_ID,Schedule_Name,Schedule_Period,Period_DayName,Period_DayNumber,CreationDate,CreationTime,Schedule_Parameter,Status from gsmSchedule where ");
                builder.Append(string.Concat(gsmSchedule_ID, "=", ParameterName(gsmSchedule_ID)));
                DataRequest request = new DataRequest(builder.ToString());
        ...
        public override DataSet ListDataSet()
        {
            ...
            try
            {
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                builder.Append("Select gsmSchedule_ID,Schedule_Name,Schedule_Period,Period_DayName,Period_DayNumber,CreationDate,CreationTime,Schedule_Parameter,Status from gsmSchedule");
                DataRequest request = new DataRequest(builder.ToString());
                 dataSet = new DataSet();
                dataSet = helper.FillDataSet(request, dataSet); 
                UserLogActivityDAL.GetInstance().GenerateAndSaveLog(string.Concat("GSM Schedule data viewed"));
        ...
        public DataSet ListScheduleDataSet()
        {
            ...
            try
            {
                ...
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                builder.Append("Select gsmSchedule_ID,Schedule_Name,Schedule_Period,Period_DayName,Period_DayNumber,CreationDate,CreationTime,Schedule_Parameter,Status from gsmSchedule where Status=1 and ");
        ...
        public override IEntity RowToEntity(DataRow row)
        {
            ...
            if (NotNullAndNotDBNull(row, CreationDate)) gsmScheduleEntity.CreationDate = Convert.ToInt64(row[CreationDate]);
            if (NotNullAndNotDBNull(row, CreationTime)) gsmScheduleEntity.CreationTime = Convert.ToString(row[CreationTime]);
        ...
        public bool IsPortFree(long scheduleID, long startDateTime,long endDateTime,string portName)
        {
            ...
            try
            {
                ...
                builder.Append(string.Concat(CreationDate, " between ", ParameterName("Start"), " and "));
                ...
                request.AddParamter(ParameterName(CreationTime), portName, DbType.String, 50);
                if (scheduleID != 0)
        ...
        public DataSet GroupScheduleDataList()
        {
            ...
            try
            {
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                builder.Append("Select A.Schedule_Name,A.Schedule_Period,A.Period_DayName,A.Period_DayNumber,A.CreationDate,A.CreationTime,A.Schedule_Parameter,A.Status,B.Group_Name,B.StartReadingDate,B.GSMSchedule_ID,B.Meter_ID ");
