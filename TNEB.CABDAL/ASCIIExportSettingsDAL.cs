...
namespace CAB.DALC.Data
{
    public class ASCIIExportSettingsDAL : DALBase
	{
        ...
        {
            IECASCIIExportSettingsEntity asciiExportSettingsEntity = null;
            if (entity == null)
                return asciiExportSettingsEntity;
            try
            {
                asciiExportSettingsEntity = entity as IECASCIIExportSettingsEntity;
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                builder.Append("Insert Into asciiexportsettings(FileName,Delimeter,GeneralColumn,GeneralDBColumn,BillingColumn,BillingDBColumn,TamperColumn,TamberDBColumn,InstantColumn,InstantDBColum,LoadSurveyColumn,LoadSurveyDBColumn) values(");
		...
		{
            IECASCIIExportSettingsEntity asciiExportSettingsEntity = new IECASCIIExportSettingsEntity();
			try
			{
				IDataHelper helper = DatabaseFactory.GetHelper();
				StringBuilder builder = new StringBuilder(); 
                builder.Append("Select Asciiexportsettings_ID,FileName,Delimeter,GeneralColumn,GeneralDBColumn,BillingColumn,BillingDBColumn,TamperColumn,TamberDBColumn,InstantColumn,InstantDBColum,LoadSurveyColumn,LoadSurveyDBColumn from asciiexportsettings where ");
                builder.Append(string.Concat(Asciiexportsettings_ID, "=", ParameterName(Asciiexportsettings_ID)));
				DataRequest request = new DataRequest(builder.ToString());
				...
				if (ds.Tables[0].Rows.Count > 0)
                    asciiExportSettingsEntity = (IECASCIIExportSettingsEntity)RowToEntity(ds.Tables[0].Rows[0]);
                UserLogActivityDAL.GetInstance().GenerateAndSaveLog("ASCII export settings viewed");
			}
			catch (CABException)
			{
        ...
        public override DataSet ListDataSet()
        {
            ...
            try
            {
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder(); 
                builder.Append("Select Asciiexportsettings_ID,FileName,Delimeter,GeneralColumn,GeneralDBColumn,BillingColumn,BillingDBColumn,TamperColumn,TamberDBColumn,InstantColumn,InstantDBColum,LoadSurveyColumn,LoadSurveyDBColumn from asciiexportsettings");
                DataRequest request = new DataRequest(builder.ToString());
                dataSet = new DataSet();
        ...
        public override bool UpdateData(IEntity entity)
        {
            ...
            try
            {
                IECASCIIExportSettingsEntity asciiExportSettingsEntity = entity as IECASCIIExportSettingsEntity;
                IDataHelper helper = DatabaseFactory.GetHelper();
                StringBuilder builder = new StringBuilder();
                ...
                builder.Append(string.Concat(LoadSurveyDBColumn, "=", ParameterName(LoadSurveyDBColumn), " where "));
                builder.Append(string.Concat(Asciiexportsettings_ID, "=", ParameterName(Asciiexportsettings_ID)));
                DataRequest request = new DataRequest(builder.ToString());
                request.AddParamter(ParameterName(FileName), asciiExportSettingsEntity.FileName, DbType.String, 50);
                request.AddParamter(ParameterName(Delimeter), asciiExportSettingsEntity.Delimeter, DbType.String, 2);
