...
namespace CAB.DALC.Data
{
    public class GSMGroupScheduleDAL : DALBase
    {
        ...
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(GSMGroupScheduleDAL).ToString());
        ...
        public bool GetDetailData(string groupName)
        {
            ...
            {
                logger.Log(LOGLEVELS.Error, "GetDetailData(string groupName)", ex);
            }
            return Flag;
        }
        ...
        public bool ValidateGroup(IEntity entity)
        {
            ...
            {
                logger.Log(LOGLEVELS.Error, "ValidateGroup(IEntity entity)", ex);
                Flag = false;
            }
            return Flag;
        }
