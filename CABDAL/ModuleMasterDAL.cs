...
namespace CAB.DALC.Data
{
	public class ModuleMasterDAL : DALBase
	{
        ...
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(ModuleMasterDAL).ToString());
        ...
        public int GetModuleIdByName(string moduleName)
        {
            ...
            {
                logger.Log(LOGLEVELS.Error, "GetModuleIdByName(string moduleName)", ex);
                moduleId=0;
            }
            return moduleId;
        }
