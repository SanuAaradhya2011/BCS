...
namespace CAB.DALC.Data
{
    public class TamperCounterDAL : DALBase
    {
        ...
        private static readonly IGeneralLog logger = LogFactory.CreateGeneralLogger(typeof(TamperCounterDAL).ToString());
        ...
        public object GetTamperCount(int meterDataId, string tamperName)
        {
            ...
            {
                logger.Log(LOGLEVELS.Error, "GetTamperCount(int meterDataId, string tamperName)", ex);
                obj = null; 
            }
            return obj;
        }
