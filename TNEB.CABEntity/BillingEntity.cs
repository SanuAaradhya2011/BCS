...
{
    public class IECBillingEntity : EntityBase
    {
        ...
        public string BillingResetType
        {
            get { return billingResetType; }
            set { billingResetType = value; }
        }
        ...
        public string PowerOffHours
        {
            get { return powerOffHours; }
            set { powerOffHours = value; }
        }
        ...
        public string CumulativeExportEnergyKVAH
        {
            get
            {
                return cumulativeExportEnergyKVAH;
            }
            set
            {
                cumulativeExportEnergyKVAH = value;
            }
        }
