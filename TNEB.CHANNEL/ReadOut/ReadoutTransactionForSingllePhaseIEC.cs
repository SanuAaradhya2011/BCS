...
{
    public class ReadoutTransactionForSingllePhaseIEC : ReadBase
    {
        public ReadoutTransactionForSingllePhaseIEC()
        {
        ...
        public override string GetData()
        {
            ...
            try
            {
                ...
                if (communications.SignOnForSPhaseIEC())
                {
                    ...
                    communications.DelayExecution();
                    Thread.Sleep(200);
                    Application.DoEvents(); // Story - 354382 - Progress bar is not moving while reading transactions for single phase
